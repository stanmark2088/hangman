...
function initialize() {
    ...
    words = ["codecool", "manchesterunited", "steauabucuresti", "lamborghini", "brabus", "reddeadredemption", "doometernal", "iloveprogramming"];
...
function checkIt() {
    ...
    if (foundIt) {
        ...
        results.innerHTML += "You have " + (totalPoints - numberOfTries) + " remaining.";

        if (numberOfTries == totalPoints) {
